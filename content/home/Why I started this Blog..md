...
!![Image Description](/images/Pasted%20image%2020250421180106.png)
...
!![Image Description](/images/Pasted%20image%2020250421191835.png)

Now, we need to add the remote GitHub repository & this can be done using the below commands
git remote add origin1 git@github.com:[^1]ethernetdude007/[^2]myblog.git
[^3]hugo
[^4]git add .
[^5]git commit -m "my first commit"
[^6]git push -u origin1 master
